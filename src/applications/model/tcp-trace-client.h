...
#ifndef TCP_TRACE_CLIENT_H
#define TCP_TRACE_CLIENT_H
 ...
 * \class TcpTraceClient
 * \brief A trace based streamer
 *
 * sends tcp packets based on a trace file of an MPEG4 stream
